...
namespace RTSFramework.Concrete.CSharp.MSTest
{
	public class ConsoleMSTestTestExecutorWithOpenCoverage<TDelta, TModel> : ConsoleMSTestTestExecutor<TDelta, TModel> where TDelta : IDelta<TModel> where TModel : IProgramModel
	{
		...
		public override async Task<ITestsExecutionResult<MSTestTestcase>> ProcessTests(IList<MSTestTestcase> impactedTests, ISet<MSTestTestcase> allTests, TDelta impactedForDelta, CancellationToken cancellationToken)
		{
